...
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/Projects/shelfstrat/runs/lmd_tests
...
#  export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/ROMS/Functionals
   ...
   export MY_ANALYTICAL_DIR=/scratch/user/dylan.schlichting/COAWST/Projects/shelfstrat/project/Functionals
